...
def composite_images_with_mask(in_raster_path_list, composite_out_path, format="GTiff"):
    ...
    combine_masks(mask_paths, composite_out_path.rsplit(".")[0]+".msk", combination_func='and', geometry_func="union")
...
def combine_masks(mask_paths, out_path, combination_func = 'and', geometry_func ="intersect"):
    ...
    for in_mask in masks:
        ...
        if geometry_func == "intersection":
            ...
            raise Exception("Invalid geometry_func; can be 'intersection' or 'union'")
