...
<qgis version="3.22.3-Białowieża" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" classificationMin="0" opacity="1" band="6" classificationMax="1" alphaBand="-1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" classificationMode="1" labelPrecision="0" maximumValue="1" colorRampType="INTERPOLATED">
          ...
          <item color="#050505" alpha="255" label="1" value="1"/>
