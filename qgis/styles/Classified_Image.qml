...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" type="paletted" band="1" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry alpha="255" color="#30123b" label="0" value="0"/>
        <paletteEntry alpha="255" color="#378627" label="1, Primary Forest" value="1"/>
        <paletteEntry alpha="255" color="#054c30" label="2, Plantation Forest" value="2"/>
        <paletteEntry alpha="255" color="#c45134" label="3, Bare Soil" value="3"/>
        <paletteEntry alpha="255" color="#f083f0" label="4, Cropland" value="4"/>
        <paletteEntry alpha="255" color="#ebee86" label="5, Grassland" value="5"/>
        <paletteEntry alpha="255" color="#1113a2" label="6, Open Water" value="6"/>
        <paletteEntry alpha="255" color="#b5b6b8" label="8, Cloud" value="8"/>
        <paletteEntry alpha="255" color="#858585" label=" 13. Artificial" value="13"/>
      </colorPalette>
