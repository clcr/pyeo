...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="12" classificationMin="0" type="singlebandpseudocolor" band="5" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" colorRampType="INTERPOLATED" labelPrecision="0" maximumValue="12" minimumValue="0" classificationMode="1">
          ...
          <item alpha="255" label="0" color="#f7fcf5" value="0"/>
          <item alpha="255" label="2" color="#e5f5e0" value="1.56"/>
          <item alpha="255" label="3" color="#c7e9c0" value="3.12"/>
          <item alpha="255" label="5" color="#a1d99b" value="4.68"/>
          <item alpha="255" label="6" color="#74c476" value="6.24"/>
          <item alpha="255" label="8" color="#41ab5d" value="7.800000000000001"/>
          <item alpha="255" label="9" color="#238b45" value="9.36"/>
          <item alpha="255" label="11" color="#006d2c" value="10.8"/>
          <item alpha="255" label="12" color="#00441b" value="12"/>
