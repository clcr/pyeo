...
<qgis styleCategories="AllStyleCategories" version="3.22.3-Białowieża" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" nodataColor="" alphaBand="-1" classificationMax="0" classificationMin="-1" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="-1" colorRampType="INTERPOLATED" labelPrecision="4" maximumValue="0" clip="0" classificationMode="2">
          ...
          <item label="-0.8000" color="#d5efcf" alpha="255" value="-0.8"/>
          <item label="-0.6000" color="#9ed798" alpha="255" value="-0.6"/>
          <item label="-0.4000" color="#55b567" alpha="255" value="-0.4"/>
          <item label="-0.2000" color="#1d8641" alpha="255" value="-0.2"/>
          <item label="0.0000" color="#00441b" alpha="255" value="0"/>
