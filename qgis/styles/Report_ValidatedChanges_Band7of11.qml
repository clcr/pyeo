...
<qgis styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="7" nodataColor="" classificationMax="20" type="singlebandpseudocolor" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" maximumValue="20" clip="0" colorRampType="INTERPOLATED" classificationMode="1" labelPrecision="0">
          ...
          <item value="0" alpha="255" label="0" color="#fff5f0"/>
          <item value="2.6" alpha="255" label="3" color="#fee0d2"/>
          <item value="5.2" alpha="255" label="5" color="#fcbba1"/>
          <item value="7.800000000000001" alpha="255" label="8" color="#fc9272"/>
          <item value="10.4" alpha="255" label="10" color="#fb6a4a"/>
          <item value="13" alpha="255" label="13" color="#ef3b2c"/>
          <item value="15.600000000000001" alpha="255" label="16" color="#cb181d"/>
          <item value="18" alpha="255" label="18" color="#a50f15"/>
          <item value="20" alpha="255" label="20" color="#67000d"/>
