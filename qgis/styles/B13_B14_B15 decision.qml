...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="1" classificationMin="0" type="singlebandpseudocolor" band="15" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" colorRampType="INTERPOLATED" labelPrecision="0" maximumValue="1" minimumValue="0" classificationMode="1">
          ...
          <item alpha="255" label="0" color="#fafafa" value="0"/>
          <item alpha="255" label="1" color="#050505" value="1"/>
