...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="20" classificationMin="0" type="singlebandpseudocolor" band="16" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader clip="0" colorRampType="INTERPOLATED" labelPrecision="0" maximumValue="20" minimumValue="0" classificationMode="1">
          ...
          <item alpha="255" label="3" color="#e5f5e0" value="2.6"/>
          <item alpha="255" label="5" color="#c7e9c0" value="5.2"/>
          <item alpha="255" label="8" color="#a1d99b" value="7.800000000000001"/>
          <item alpha="255" label="10" color="#74c476" value="10.4"/>
          <item alpha="255" label="13" color="#41ab5d" value="13"/>
          <item alpha="255" label="16" color="#238b45" value="15.600000000000001"/>
          <item alpha="255" label="18" color="#006d2c" value="18"/>
          <item alpha="255" label="20" color="#00441b" value="20"/>
