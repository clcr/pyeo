...
<qgis styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.28.1-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="11" nodataColor="" classificationMax="8600" type="singlebandpseudocolor" classificationMin="6935">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="6935" maximumValue="8600" clip="0" colorRampType="INTERPOLATED" classificationMode="1" labelPrecision="0">
          ...
          <item value="6935" alpha="255" label="6935" color="#f7fbff"/>
          <item value="7151.45" alpha="255" label="7151" color="#deebf7"/>
          <item value="7367.9" alpha="255" label="7368" color="#c6dbef"/>
          <item value="7584.35" alpha="255" label="7584" color="#9ecae1"/>
          <item value="7800.8" alpha="255" label="7801" color="#6baed6"/>
          <item value="8017.25" alpha="255" label="8017" color="#4292c6"/>
          <item value="8233.7" alpha="255" label="8234" color="#2171b5"/>
          <item value="8433.5" alpha="255" label="8434" color="#08519c"/>
          <item value="8600" alpha="255" label="8600" color="#08306b"/>
