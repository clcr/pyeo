...
var run_change_detection = function (params) {
  ...
  if (indexGate.use) {
    ...
    print("changeEvents: index gate applied")
  ...
  if (!indexGate.use) {
    ...
    print("changeEvents: no index gate applied")
  ...
  if (indexGate.use) {
    ...
    print("changeReport: index gate applied")
  ...
  if (!indexGate.use) {
    ...
    print("changeReport: no index gate applied")
